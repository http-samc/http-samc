...
- 🔭 I’m currently working on [tournaments.tech](http://tournaments.tech) and **`<REDACTED>`** (coming soon 👀 📈 🚀)
...
- 📫 Email me at [sam@chitgopekar.tech](mailto:sam@chitgopekar.tech)


### Blog Posts:
<!-- BLOG-POST-LIST:START -->
- [in-memory databases: a practical demo](https://dev.to/httpsamc/in-memory-databases-a-pratical-demo-4bmp)
